...
from ...services.ai.indexer import index_receipt, deindex_receipt


def _category_name(db: Session, category_id):
    if not category_id:
        return None
...
def create_receipt(
    ...
    index_receipt(db_receipt, _category_name(db, db_receipt.category_id))
    return db_receipt
